...
export default function Hero({ searchQuery, setSearchQuery, onUseLocation }) {
      ...
      >
        <div className="bg-white dark:bg-gray-800 p-2 rounded-full shadow-lg border border-gray-100 dark:border-gray-700 flex items-center gap-2 transition-colors">
          ...
          <button
            ...
            className="hidden sm:block text-xs font-medium text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 px-3 py-2 transition"
          >
            Gunakan lokasi saya
          </button>
          ...
          <button
            ...
            className="bg-red-600 hover:bg-red-700 text-white font-medium text-xs px-5 py-2.5 rounded-full transition shadow-sm"
          >
            Cari BBM
          </button>
